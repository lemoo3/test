...
import { searchCollege } from "../store/colleges/effects";
...
const College = () =>{
  ...
  const handleSearch = () =>{
    dispatch(searchCollege(colleges.search));
  }
          ...
          <FormControl
           ...
           className={classes.formField}>
             ...
             <Select
              ...
              onChange={e=> handleCollegeChange({faculty: e.target.value as string})}
             >
